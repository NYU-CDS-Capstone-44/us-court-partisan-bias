...
df = pd.read_csv('/vast/amh9750/lc_output_chunk_5.csv')

df_null_decision_text = df[df['decision_text'].isnull()]
df_null_decision_text.to_csv('lc_null_decision_text_chunk_5.csv', index=False)
...
df_large.to_csv('lc_greater_than_35_chunk_5.csv', index=False)
df_small.to_csv('lc_less_than_35_chunk_5.csv', index=False)
