...
log_file_path = f'log_file_{MAX_SEQUENCE_LENGTH}trunc_{NUMBER_OF_NODES}nodes_{NUMBER_OF_LAYERS}layers_names_removed_summary_{DROPOUT_AMOUNT}drop15epochs.txt'
...
model.save(f'RNN_LSTM_{MAX_SEQUENCE_LENGTH}trunc_{NUMBER_OF_NODES}nodes_{NUMBER_OF_LAYERS}layers_names_removed_summary_{DROPOUT_AMOUNT}drop15epochs.h5')
model_end = time.time()
