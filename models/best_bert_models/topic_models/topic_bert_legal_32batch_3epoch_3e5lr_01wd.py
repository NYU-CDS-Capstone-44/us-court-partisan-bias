...
version = '32batch_3epoch_3e5lr_01wd'
...
model_name = f"topic-legal-bert-base-uncased-supreme-court-{version}"
...
finetune_model_name = f'annabellehuether/topic-legal-bert-base-uncased-supreme-court-{version}'
...
file_name = f'topic_legal_bert_metrics_{version}.txt'
...
test_results.to_csv(f'topic_legal_bert_test_results_{version}.csv')
