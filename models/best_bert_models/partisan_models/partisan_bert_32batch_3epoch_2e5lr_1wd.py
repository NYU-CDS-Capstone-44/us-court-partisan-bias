...
version = '32batch_3epoch_2e5lr_1wd'
...
model_name = f"partisan-bert-base-uncased-supreme-court-{version}"
...
finetune_model_name = f'annabellehuether/partisan-bert-base-uncased-supreme-court-{version}'
...
file_name = f'partisan_bert_metrics_{version}.txt'
...
test_results.to_csv(f'partisan_bert_test_results_{version}.csv')
