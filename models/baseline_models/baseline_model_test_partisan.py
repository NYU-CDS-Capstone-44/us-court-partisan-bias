...
with open('baseline_model_partisan.pkl', 'rb') as file:
...
test_with_predictions_and_probabilities.to_csv('baseline_test_partisan_predictions.csv', index=False)



# Calculate and save test accuracy to a text file
test_accuracy = accuracy_score(y, predictions)
with open('baseline_test_partisan_accuracy.txt', 'w') as file:
