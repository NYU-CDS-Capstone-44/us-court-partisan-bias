...
# Load Word2Vec model
w2v_model = Word2Vec.load("/vast/amh9750/w2v_embeddings.bin")
...
# Load data
train = pd.read_csv('/vast/amh9750/sc-train.csv')
...
# Change partisan labels to 0 and 1 
y = np.array(y)
y = (y == 1.0).astype(int)
...
param_grid = {
    'n_estimators': [700, 800, 900, 1000],  # Number of boosting stages (trees)
    'max_depth': [9, 10, 11, 12],  # Maximum depth of individual trees
}
...
output_file = "baseline_model_2.txt"
