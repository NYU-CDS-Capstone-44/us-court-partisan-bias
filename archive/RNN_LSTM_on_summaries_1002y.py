...
log_file_path = f'/scratch/amr10211/capstone/RNN_LSTM_models/log_file_{MAX_SEQUENCE_LENGTH}trunc_{NUMBER_OF_NODES}nodes_{NUMBER_OF_LAYERS}layers_names_removed_summary_{DROPOUT_AMOUNT}drop_removed_numbers.txt'
...
# Read data
train = pd.read_csv('/home/amr10211/us-court-partisan-bias/summarized-opinions-data-sc.csv')
...
# Tokenize and Vectorize data
X_train, y_train = tokenize_vectorize(train['decision_text'], train['scdb_decision_direction'], w2v_model, MAX_SEQUENCE_LENGTH)
X_val, y_val = tokenize_vectorize(val['decision_text'], val['scdb_decision_direction'], w2v_model, MAX_SEQUENCE_LENGTH)
...
model.save(f'/scratch/amr10211/capstone/RNN_LSTM_models/RNN_LSTM_{MAX_SEQUENCE_LENGTH}trunc_{NUMBER_OF_NODES}nodes_{NUMBER_OF_LAYERS}layers_names_removed_summary_{DROPOUT_AMOUNT}drop_removed_numbers.h5')
model_end = time.time()
