...
#Load Inference Data
inference_df = pd.read_csv(f'/scratch/amh9750/capstone/bert_inference/inference_results_legal_BERT_chunk_{chunk}.csv') #UPDATE
...
visualization_df.to_csv(f'/vast/amr10211/visualization_results_legal_BERT_chunk_{chunk}.csv') #UPDATE
