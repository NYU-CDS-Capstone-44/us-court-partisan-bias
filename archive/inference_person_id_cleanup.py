...
#Load Inference Data
inference_df = pd.read_csv(f'/scratch/amh9750/capstone/bert_inference/inference_results_legal_BERT_chunk_{1}.csv')
...
# Filter for termination date greater than 1930
people_positions_df = people_positions_df[people_positions_df['date_termination'].dt.year >= 1930]
...
visualization_df.to_csv(f'/vast/amr10211/visualization_results_legal_BERT_chunk_{chunk}_TEST.csv')
