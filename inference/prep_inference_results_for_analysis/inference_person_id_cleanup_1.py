...
#Load Inference Data
inference_df = pd.read_csv(f'/scratch/amh9750/capstone/bert_inference/inference_results_legal_BERT_chunk_{chunk1}.csv') #UPDATE
...
visualization_df['partisanship'] = visualization_df['partisanship_y'].fillna(visualization_df['partisanship_x'])

# Drop unnecessary columns
visualization_df = visualization_df.drop(['partisanship_x', 'partisanship_y'], axis=1)

print('Saving to CSV: ', time.time())
visualization_df.to_csv(f'/vast/amr10211/visualization_results_legal_BERT_chunk_{chunk1}-2.csv') #UPDATE
